...

{
  ...
  {tweets.length === 0 ? <NoTweets message={"You have not posted any tweets"}/>   : tweets.map( (ele , index) => <TweetCard key={index}  tweetKey={ele.publicKey.toBase58()} tag={ele.account.tag} author={ele.account.user.toBase58()} content={ele.account.content} /> )}
</div>
}
