...
<svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white hover:text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path d="M20.25 2.25h-16.5c-1.24 0-2.25 1.01-2.25 2.25v12.6c0 1.24 1.01 2.25 2.25 2.25h2.25v3.375c0 .414.336.75.75.75h3c.414 0 .75-.336.75-.75v-3.375h8.25c1.24 0 2.25-1.01 2.25-2.25v-12.6c0-1.24-1.01-2.25-2.25-2.25zm-.75 12.6c0 .69-.56 1.25-1.25 1.25h-8.25c-.69 0-1.25-.56-1.25-1.25v-10.5c0-.69.56-1.25 1.25-1.25h8.25c.69 0 1.25.56 1.25 1.25v10.5z"/>
</svg>
